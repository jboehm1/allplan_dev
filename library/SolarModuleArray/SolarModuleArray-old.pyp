...
<Element>
  <Script>
    ...
    <Title>Solar Carport Roof</Title>
    <Version>1.0</Version>
  </Script>
  ...
  <Page>
    ...
    <Parameter>
      <Name>CreateSecondSide</Name>
      <Text>Create second roof side</Text>
      <Value>True</Value>
  ...
  <Page>
    <Name>Roof</Name>
    <Text>Roof Configuration</Text>
    <Visible>CreateSecondSide == True</Visible>
    
    <Parameter>
      <Name>RoofAngle</Name>
      <Text>Roof angle (degrees)</Text>
      <Value>15</Value>
    ...
    <Parameter>
      <Name>RidgeHeight</Name>
      <Text>Ridge height offset (mm)</Text>
      <Value>1000</Value>
